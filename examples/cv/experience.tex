...
%---------------------------------------------------------
  \cventry
    ...
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {I Worked as System Administrator in R&D Department. My main responsibilities were permanence of system integrity, deploy and manage new services and also end-user support.}
      \end{cvitems}
    }
%---------------------------------------------------------
\end{cventries}