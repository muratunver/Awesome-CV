...
%---------------------------------------------------------
  \cventry
    ...
    {Provide to become great team player for my team colleagues each together and also guiding to their career, technical skills and learning more than current times.Generally, i take responsibility for some critical situations for our customers and take action and help my colleagues}%Description
    {
...
%---------------------------------------------------------
  \cventry
    ...
    Some products that I have installed, maintained and managed;} % Description
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
